...
c.LabApp.default_url = (
    "/lab/tree{}".format(
        jupyter_lab_default_url.replace(
            os.getenv("JUPYTER_FILE_CONTENTS_MANAGER_ROOT_DIR", "/home"), ""
        )
    )
...
#  Default: '/home/anaconda/.jupyter/lab/user-settings'
# c.LabApp.user_settings_dir = '/home/anaconda/.jupyter/lab/user-settings'
...
#  Default: '/home/anaconda/.jupyter/lab/workspaces'
# c.LabApp.workspaces_dir = '/home/anaconda/.jupyter/lab/workspaces'
